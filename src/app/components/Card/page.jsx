      ...
      <div className="container mx-auto">
        ...
        >
          {[
            ...
            <div
              key={index}
              className="relative hover:bg-gray-800 bg-white md:p-8 p-6 flex md:flex-col gap-6 md:gap-4 place-items-center shadow-md rounded-2xl hover:shadow-inner-xl group"
            >
              ...
              <svg
                className="absolute inset-0 left-0 top-0 z-30 opacity-0 fill-sky-800 group-hover:opacity-100 group-hover:duration-300 group-hover:transition-all group-active:fill-sky-950"
...
//               </div>
//               <svg
//                 class="absolute inset-0 left-0 top-0  z-30 opacity-0 fill-sky-800 group-hover:opacity-100 group-hover:duration-300 group-hover:transition-all group-active:fill-sky-950"
//                 preserveAspectRatio="xMidYMid meet"
//                 viewBox="0 0 204.000000 113.000000"
//                 xmlns="http://www.w3.org/2000/svg"
//                 version="1.0"
...
// import { SiGoogleanalytics } from "react-icons/si";
// import { motion } from "framer-motion";
// import { useInView } from "react-intersection-observer"; // Ensure correct library import

// const Card = () => {
//   const [ref, inView] = useInView({
//     threshold: 0.3, // Adjust how much of the component needs to be in view to trigger
//     triggerOnce: false, // Set to false so animation runs repeatedly as the element enters/exits the viewport
//   });

//   // Animation Variants
//   const cardVariants = {
//     hidden: { opacity: 0, x: -100 }, // Start state
//     visible: { opacity: 1, x: 0 }, // End state when in view
//     exit: { opacity: 0, x: 100 }, // State when scrolling past
//   };
...
//       <div className="container mx-auto">
//         <motion.div
//           ref={ref} // Attach the reference to the container
//           initial="hidden" // Initial animation state
//           animate={inView ? "visible" : "exit"} // Animate based on `inView`
//           variants={cardVariants} // Variants for the animation
//           transition={{ duration: 0.6, ease: "easeInOut" }} // Customize animation timing
//           className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"
//         >
//           {[
//             { title: "Business Growth", icon: <MdBusinessCenter /> },
