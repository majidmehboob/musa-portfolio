...
const Card = () => {
  return (
    <section className=" py-10 md:px-20 px-10 bg-blue-100">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={index}
              className="bg-white hover:bg-gray-900 p-8 flex md:flex-col gap-7 md:gap-4 place-items-center shadow-md rounded-2xl hover:shadow-inner-xl group"
            >
