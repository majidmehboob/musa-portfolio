  ...
  return (
    <div ref={scope}>
      <button
        ...
        class="relative md:px-6 px-3 py-2 text-lg bg-gradient-to-r from-blue-400 to-blue-700 hover:bg-gradient-to-r hover:from-blue-900 hover:to-blue-800  rounded-full shadow-md text-white  overflow-hidden z-30 group hover:bg-sky-800 transition-all duration-500 tracking-wider font-semibold"
      >
        ...
        <span className="block h-8 overflow-hidden" aria-hidden>
          {[...name].map((letter, index) => (
            <span
              data-letter={letter}
              className="letter relative inline-block h-8 leading-2 after:absolute after:left-0 after:top-full after:h-8 after:content-[attr(data-letter)]"
              key={`${letter}-${index}`}
            >
              {letter}
            </span>
